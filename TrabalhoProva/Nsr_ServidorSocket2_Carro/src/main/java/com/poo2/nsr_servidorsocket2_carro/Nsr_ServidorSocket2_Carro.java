...
package com.poo2.nsr_servidorsocket2_carro;
 ...
 */
public class Nsr_ServidorSocket2_Carro extends JFrame {
    ...
    private String Nsr_arquivoDados = "cadastro_carros2.txt";
    ...
    public Nsr_ServidorSocket2_Carro() {
    ...
    private void Nsr_initComponents() {
        ...
        Nsr_selecionarArquivoButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (fileChooser.showOpenDialog(Nsr_ServidorSocket2_Carro.this) == JFileChooser.APPROVE_OPTION) {
        ...
        Nsr_iniciarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(Nsr_ServidorSocket2_Carro.this, 
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Nsr_ServidorSocket2_Carro().setVisible(true);
            }
        });
    }
}